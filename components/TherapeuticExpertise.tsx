...
const expertiseData = [
    ...
    },
    {
        ...
        icon: <Dna className="w-8 h-8 text-sky-500" />,
    },
    {
        title: "Neurology",
...
export default function TherapeuticExpertise() {
    return (
        <section id="expertise" className="py-24 bg-slate-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-50/50 rounded-full blur-3xl opacity-60 z-0 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-sky-50/40 rounded-full blur-3xl opacity-60 z-0 pointer-events-none" />
            ...
            <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 perspective-1000">
                    {expertiseData.map((item, i) => {
                        ...
                        const hoverGradients = [
                            "group-hover:from-teal-100 group-hover:to-emerald-100",
                            "group-hover:from-sky-100 group-hover:to-blue-100",
                            "group-hover:from-emerald-100 group-hover:to-teal-100",
                            "group-hover:from-teal-100 group-hover:to-sky-100",
                            "group-hover:from-sky-100 group-hover:to-indigo-100",
                            "group-hover:from-emerald-100 group-hover:to-green-100"
                        ];
                        return (
                            <motion.div
                                key={item.title}
                                ...
                                className={`bg-gradient-to-br ${gradients[i % gradients.length]} ${hoverGradients[i % hoverGradients.length]} p-8 rounded-[2rem] shadow-sm border border-white hover:shadow-2xl hover:shadow-teal-900/10 hover:-translate-y-2 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] group relative overflow-hidden`}
                            >
                                <div className="absolute top-0 right-0 w-32 h-32 bg-white/40 rounded-bl-full opacity-50 transition-transform duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] origin-top-right group-hover:scale-150" />
                                <div className="w-16 h-16 bg-white text-teal-600 rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-white/60 group-hover:scale-110 transition-transform duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] relative z-10">
                                    {item.icon}
                                </div>
                ...
                <motion.div
                    ...
                    className="mt-20 bg-teal-600 text-white rounded-[2.5rem] p-10 md:p-14 text-center relative overflow-hidden shadow-2xl"
                >
                    ...
                    <div className="absolute -top-32 -right-32 w-64 h-64 bg-teal-400/30 rounded-full blur-3xl pointer-events-none" />

                    <h3 className="text-3xl md:text-4xl font-extrabold mb-6 relative z-10 tracking-tight">Need Specialized Genomic Analysis?</h3>
                    <p className="text-lg md:text-xl text-teal-50 mb-8 max-w-2xl mx-auto relative z-10 font-medium leading-relaxed">
                    ...
                    <button className="relative z-10 px-8 py-4 bg-white text-teal-700 rounded-full font-bold text-lg hover:bg-slate-50 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] shadow-lg hover:shadow-xl hover:-translate-y-1">
